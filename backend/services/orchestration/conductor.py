...
class GeminiConductor:
    ...
    def _build_routing_prompt(self, message: str, task_type: str, mama_bear_variant: Optional[str],
        ...
        return f"""
🎼 GEMINI ORCHESTRA CONDUCTOR ANALYSIS
