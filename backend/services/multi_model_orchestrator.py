"""
🌟 Multi-Model Orchestrator for Podplay Sanctuary
...
class MultiModelOrchestrator:
    ...
    def __init__(self):
        ...
        logger.info("🌟 Multi-Model Orchestrator initialized for Podplay Sanctuary")
    ...
    def _initialize_models(self):
        ...
        if os.getenv('ANTHROPIC_API_KEY'):
            ...
            logger.info("✅ Claude 3.5 Sonnet initialized with Computer Use API support")
        ...
        if os.getenv('GOOGLE_API_KEY'):
            ...
            logger.info("✅ Gemini 2.5 Pro initialized with advanced function calling support")
    ...
    def _register_sanctuary_functions(self):
        ...
        logger.info(f"📚 Registered {len(self.function_registry)} Sanctuary functions")
    ...
    async def route_request(self, 
        ...
        if CapabilityType.COMPUTER_USE in capabilities_needed:
            if best_provider != ModelProvider.CLAUDE:
                logger.info(f"🔄 Routing Computer Use request from {best_provider.value} to Claude 3.5")
    ...
    async def _execute_gemini(self, client, config, prompt, user_id, functions):
        ...
        try:
            ...
            return {
                ...
                "provider": "gemini",
                "error": str(e),
                "sanctuary_note": "💜 Gemini encountered an issue, but we're here to help"
            }
...
async def create_multi_model_orchestrator() -> MultiModelOrchestrator:
    ...
    logger.info("🌟 Multi-Model Orchestrator ready for Podplay Sanctuary")
    return orchestrator