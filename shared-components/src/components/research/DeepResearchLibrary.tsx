...
interface CollaborativeSession {
  ...
  claudeModel: string
  geminiModel: string
  geminiExpressModel?: string
  currentStatus: "claude_thinking" | "gemini_thinking" | "synthesizing" | "streaming" | "complete"
  progress: number
...
interface LiveUpdate {
  id: string
  model: "claude" | "gemini" | "synthesis"
  modelName?: string
  type: "thinking" | "researching" | "analyzing" | "finding" | "insight" | "synthesis" | "streaming"
  message: string
  timestamp: Date
  progress: number
  sources?: string[]
...
// Enhanced Vertex AI Express Mode Configuration
const VERTEX_AI_EXPRESS_MODELS = {
  ...
  "gemini-2.5-pro-preview-03-25": {
    ...
    rateLimit: 30,
    bestFor: ["complex reasoning", "analysis", "research"]
  },
  "gemini-2.5-flash-preview-05-20": {
    name: "Gemini 2.5 Flash (Latest)",
    description: "Latest Flash model with enhanced capabilities",
    tier: "express",
    speed: "fast",
    contextWindow: 1048576,
    rateLimit: 30,
    bestFor: ["quick responses", "real-time chat", "collaboration"]
  },
  
  // Gemini 2.0 Series (Real-time Optimized)
  "gemini-2.0-flash-001": {
    name: "Gemini 2.0 Flash",
    description: "Real-time optimized for streaming",
    tier: "express",
    speed: "ultra-fast",
    contextWindow: 1048576,
    rateLimit: 30,
    bestFor: ["streaming", "real-time collaboration", "quick research"]
  },
  "gemini-2.0-flash-lite-001": {
    name: "Gemini 2.0 Flash Lite",
    description: "Lightweight variant for maximum speed",
    tier: "express",
    speed: "lightning",
    contextWindow: 32768,
    rateLimit: 30,
    bestFor: ["ultra-fast responses", "simple queries", "initial research"]
  },

  // Gemini 1.5 Series (Proven & Stable)
  "gemini-1.5-flash-002": {
    name: "Gemini 1.5 Flash",
    description: "Stable and reliable for general use",
    tier: "standard",
    speed: "fast",
    contextWindow: 1048576,
    rateLimit: 60,
    bestFor: ["general research", "balanced performance", "reliable results"]
  },
  "gemini-1.5-flash-8b-001": {
    ...
    contextWindow: 1048576,
    rateLimit: 100,
    bestFor: ["ultra-low latency", "cost optimization", "quick tasks"]
  }
}

// Intelligent Model Selection
const MODEL_SELECTION_GUIDE = {
  "ultra_low_latency": "gemini-1.5-flash-8b-001",
  "general_research": "gemini-1.5-flash-002", 
  "complex_reasoning": "gemini-2.5-pro-preview-03-25",
  "real_time_streaming": "gemini-2.0-flash-001",
  "collaborative_research": "gemini-2.5-flash-preview-05-20",
  "cost_optimized": "gemini-2.0-flash-lite-001"
}

// Research Depth Configuration with Express Mode Integration
const RESEARCH_DEPTH_CONFIG = {
  search: {
    name: "Quick Search",
    description: "Lightning-fast research (30s-2min)",
    icon: <Search className="w-4 h-4" />,
    color: "text-green-400",
    estimatedTime: 90,
    recommendedModel: "gemini-2.0-flash-lite-001",
    tier: "express"
  },
  deep: {
    name: "Deep Research", 
    description: "Comprehensive investigation (5-15min)",
  ...
  deep_deep: {
    ...
    description: "Exhaustive multi-model investigation (20-45min)",
    icon: <TrendingUp className="w-4 h-4" />,
    color: "text-purple-400",
    estimatedTime: 1800,
    recommendedModel: "gemini-2.5-pro-preview-03-25",
    tier: "premium"
  }
}
